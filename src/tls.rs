...
extern "C" {
    ...
    fn SSL_ctrl(ssl: SSL, cmd: i32, larg: i64, parg: *const std::ffi::c_void) -> i64;
    fn SSL_connect(ssl: SSL) -> i32;
    fn SSL_read(ssl: SSL, buf: *mut u8, num: i32) -> i32;
    fn SSL_write(ssl: SSL, buf: *const u8, num: i32) -> i32;
    fn SSL_shutdown(ssl: SSL) -> i32;
    fn SSL_get_error(ssl: SSL, ret: i32) -> i32;
    fn SSL_CTX_set_default_verify_paths(ctx: SSL_CTX) -> i32;
    fn SSL_CTX_set_verify(ctx: SSL_CTX, mode: i32, callback: *const std::ffi::c_void);
    fn ERR_error_string_n(e: u64, buf: *mut u8, len: usize);
...
extern "C" {
    ...
    fn EVP_aes_256_cbc() -> *const std::ffi::c_void;
    fn EVP_EncryptInit_ex(ctx: *mut std::ffi::c_void, cipher: *const std::ffi::c_void, engine: *const std::ffi::c_void, key: *const u8, iv: *const u8) -> i32;
    fn EVP_EncryptUpdate(ctx: *mut std::ffi::c_void, out: *mut u8, outl: *mut i32, inp: *const u8, inl: i32) -> i32;
    fn EVP_EncryptFinal_ex(ctx: *mut std::ffi::c_void, out: *mut u8, outl: *mut i32) -> i32;
    fn EVP_DecryptInit_ex(ctx: *mut std::ffi::c_void, cipher: *const std::ffi::c_void, engine: *const std::ffi::c_void, key: *const u8, iv: *const u8) -> i32;
    fn EVP_DecryptUpdate(ctx: *mut std::ffi::c_void, out: *mut u8, outl: *mut i32, inp: *const u8, inl: i32) -> i32;
    fn EVP_DecryptFinal_ex(ctx: *mut std::ffi::c_void, out: *mut u8, outl: *mut i32) -> i32;
...
extern "C" {
    fn EVP_PKEY_CTX_new_id(id: i32, engine: *const std::ffi::c_void) -> *mut std::ffi::c_void;
    fn EVP_PKEY_CTX_new(pkey: *mut std::ffi::c_void, engine: *const std::ffi::c_void) -> *mut std::ffi::c_void;
    fn EVP_PKEY_keygen_init(ctx: *mut std::ffi::c_void) -> i32;
    fn EVP_PKEY_CTX_set_rsa_keygen_bits(ctx: *mut std::ffi::c_void, bits: i32) -> i32;
    fn EVP_PKEY_keygen(ctx: *mut std::ffi::c_void, pkey: *mut *mut std::ffi::c_void) -> i32;
    fn EVP_PKEY_CTX_free(ctx: *mut std::ffi::c_void);
    fn EVP_PKEY_free(pkey: *mut std::ffi::c_void);
    fn EVP_PKEY_sign_init(ctx: *mut std::ffi::c_void) -> i32;
    fn EVP_PKEY_sign(ctx: *mut std::ffi::c_void, sig: *mut u8, siglen: *mut usize, tbs: *const u8, tbslen: usize) -> i32;
    fn EVP_PKEY_verify_init(ctx: *mut std::ffi::c_void) -> i32;
    fn EVP_PKEY_verify(ctx: *mut std::ffi::c_void, sig: *const u8, siglen: usize, tbs: *const u8, tbslen: usize) -> i32;
    fn i2d_PrivateKey(pkey: *mut std::ffi::c_void, pp: *mut *mut u8) -> i32;
    fn i2d_PUBKEY(pkey: *mut std::ffi::c_void, pp: *mut *mut u8) -> i32;
    fn d2i_PrivateKey(type_: i32, pkey: *mut *mut std::ffi::c_void, pp: *mut *const u8, length: i64) -> *mut std::ffi::c_void;
    fn d2i_PUBKEY(pkey: *mut *mut std::ffi::c_void, pp: *mut *const u8, length: i64) -> *mut std::ffi::c_void;
}
...
extern "C" {
    fn EC_KEY_new_by_curve_name(nid: i32) -> *mut std::ffi::c_void;
    fn EC_KEY_generate_key(key: *mut std::ffi::c_void) -> i32;
    fn EC_KEY_free(key: *mut std::ffi::c_void);
    fn EVP_PKEY_new() -> *mut std::ffi::c_void;
    // EVP_PKEY_assign_EC_KEY is a macro: EVP_PKEY_assign(pkey, EVP_PKEY_EC, key)
    fn EVP_PKEY_assign(pkey: *mut std::ffi::c_void, type_: i32, key: *mut std::ffi::c_void) -> i32;
}
...
extern "C" {
    fn EVP_chacha20_poly1305() -> *const std::ffi::c_void;
}
...
pub fn chacha20_encrypt(key: &[u8], plaintext: &[u8]) -> Result<Vec<u8>, String> {
    ...
    unsafe {
        ...
        extern "C" { fn EVP_CIPHER_CTX_ctrl(ctx: *mut std::ffi::c_void, typ: i32, arg: i32, ptr: *mut u8) -> i32; }
