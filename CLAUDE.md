...
Zero dependencies. ~114,000 lines. 3,215 tests (1,657 lib + 1,558 integration).

## Commands

```bash
cargo build --bin magi
cargo test --lib                     # 1657 tests
cargo test --test integration        # 1558 tests (needs RUST_MIN_STACK=33554432)
```
